...
export const ProgrammingIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
  </svg>
);

export const DataRepresentationIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const SoftwareIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c.251.023.501.05.75.082m.75.082a24.301 24.301 0 014.5 0m4.5 0a24.301 24.301 0 014.5 0m0 0v5.714c0 .597-.237 1.17-.659 1.591L19.8 15.3m-5.85-7.532c.251.023.501.05.75.082m.75.082a24.301 24.301 0 014.5 0m4.5 0a24.301 24.301 0 014.5 0m0 0v5.714c0 .597-.237 1.17-.659 1.591L19.8 15.3m-5.85-7.532l-3.226 3.226a2.25 2.25 0 00-.659 1.591v5.714m0-5.714L12 12.5m0 0l4.5 4.5m-4.5-4.5l-4.5 4.5" />
  </svg>
);

export const NetworkIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.288 15.043A5.25 5.25 0 017.5 15h-3a2.25 2.25 0 01-2.25-2.25V7.5A2.25 2.25 0 014.5 5.25h3.75m0 0a5.25 5.25 0 015.25 0m0 0a5.25 5.25 0 015.25 0M8.25 5.25h3.75m0 0a5.25 5.25 0 015.25 0m0 0h3.75a2.25 2.25 0 012.25 2.25v5.25a2.25 2.25 0 01-2.25 2.25h-3a5.25 5.25 0 01-1.212-.257M15.75 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);
...
export const EthicsIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c.504 0 1.002-.02 1.49-.06M12 21c-.504 0-1.002-.02-1.49-.06M3.283 14.255a9.004 9.004 0 010-4.509l5.016 2.253a0.75 0.75 0 00.916 0l5.016-2.253a9.004 9.004 0 010 4.509l-5.016-2.253a0.75 0.75 0 00-.916 0l-5.016 2.253zM12 3c-1.928 0-3.722.533-5.283 1.499l5.016 2.253a0.75 0.75 0 00.916 0l5.016-2.253C15.722 3.533 13.928 3 12 3z" />
  </svg>
);
...
export const LessonPlannerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
// New icons for learning modules
...
export const VocabularyIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const WorldIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18zM3.54 9H20.5M3.54 15H20.5" />
  </svg>
);
